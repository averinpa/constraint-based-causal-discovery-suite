...
from bnm.compare import DESCRIPTIVE_METRIC_NAMES, compare
from bnm.exceptions import BNMInputError
from bnm.viz._compare_models import _require_plotly_subplots
    ...
    *,
    ...
    Args:
        ...
        descriptive: which descriptive metrics to plot. Default
            ``"all"`` of :data:`bnm.DESCRIPTIVE_METRIC_NAMES`.
