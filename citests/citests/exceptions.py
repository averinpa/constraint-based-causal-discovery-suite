"""Exception hierarchy for citests.

All citests-defined exceptions inherit from :class:`CITKError`. The leaf classes
...
Catch :class:`CITKError` to handle any citests failure uniformly; catch a
subclass to discriminate between the failure modes.
"""


class CITKError(Exception):
    """Base class for all citests-specific exceptions."""
