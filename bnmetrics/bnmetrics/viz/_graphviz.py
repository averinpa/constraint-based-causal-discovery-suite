...
def _require_graphviz() -> Any:
    try:
        ...
        raise BNMError(
            "bnmetrics.viz requires the `viz` extra. Install with `pip install bnmetrics[viz]` "
...
class _SideBySideDot:
    ...
    unpacking (``dot1, dot2 = bnmetrics.plot_side_by_side(...)``); supports
...
def plot_side_by_side(
    ...
    *,
    ...
    """
    from bnmetrics.exceptions import BNMDataError  # local to avoid surfacing in __init__
