...
:func:`bnm.adapter._to_endpoints`. Required: equal ``n_vars`` post-
normalisation; mismatch raises :class:`bnm.BNMDataError`. Variable-name
...
bnm 0.1.x has no bidirected handling; the legacy-parity tests don't
...
from bnm.exceptions import BNMDataError
