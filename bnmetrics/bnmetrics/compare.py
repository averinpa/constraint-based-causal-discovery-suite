...
from bnmetrics.adapter import _resolve_var, _to_endpoints, to_graphlike
...
from bnmetrics.exceptions import BNMDataError, BNMInputError
from bnmetrics.markov_blanket import markov_blanket_indices
...
def to_dataframe(comparison: Comparison) -> Any:
    ...
    try:
        ...
        from bnmetrics.exceptions import BNMError  # noqa: PLC0415

        raise BNMError(
            "bnmetrics.to_dataframe requires pandas. Install with "
            "`pip install bnmetrics[pandas]` or `pip install pandas`."
        ) from exc
