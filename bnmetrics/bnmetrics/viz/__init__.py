...
free of UI deps. Importing :mod:`bnmetrics.viz` itself does NOT trigger any
...
- Per the audit, 0.1.x's viz was tightly coupled to the ``BNMetrics``
  ...
  any GraphLikeInput and uses :func:`bnmetrics.markov_blanket` when the
...
from bnmetrics.viz._compare_models import (
    compare_models_comparative,
    compare_models_descriptive,
)
from bnmetrics.viz._graphviz import plot_graph, plot_side_by_side
from bnmetrics.viz._mb_distribution import analyse_mb
from bnmetrics.viz._sid_matrix import plot_sid_matrix
