...
Edge-mark conventions (matching :class:`bnmetrics.EndpointMark`):
...
module matches bnmetrics 0.1.x exactly — verified by the legacy snapshot in
...
def count_bidirected_arcs(g: object) -> int:
    """Edges with two ARROW endpoints. (Not present in bnmetrics 0.1.x output;
